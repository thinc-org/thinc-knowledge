...
UX/UI Design เป็นกลุ่มคำที่รวมสองทักษะที่สำคัญในการ design (การออกแบบ) product หนึ่งขึ้นมา โดยเฉพาะ digital product ไว้ว่าจะเป็น mobile application, website, หรือ software ประเภทอื่น ๆ โดยทักษะทั้งสองอย่างนี้จะช่วยให้ผู้ใช้สามารถใช้งาน product ที่เราออกแบบได้สะดวก และตรงกับความต้องการของผู้ใช้
